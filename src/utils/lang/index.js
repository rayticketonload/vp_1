...
import { readls, savels } from 'UTILS/storageControl';
...
const localLang =
  sysLang === config.langKeys.zhcn || sysLang === config.langKeys.enus
    ...
    : false;
const currentlang =
  readls(config.storageLangKeyName) || localLang || config.langKeys.zhcn;
// 保存默认语言
savels(config.storageLangKeyName, currentlang);
